      ...
      <section className="py-12 lg:py-16 px-6 lg:px-16 max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-12 lg:gap-20">
          ...
          <motion.div {...fadeUp(0.08)} className="space-y-8">
            <p className="text-[9px] font-bold tracking-[0.5em] uppercase text-[#82000D]/70">Offices</p>

            {/* Main office card */}
            <div className="border border-[#82000D]/15 p-8 space-y-6 bg-[#F3EFE9]">
              <h3 className="text-lg font-serif text-[#1C1714]">Westlands Office</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <MapPin size={14} className="text-[#82000D] mt-0.5 shrink-0" />
                  <p className="text-[13px] text-[#1C1714]/70 leading-relaxed font-light">{address}</p>
                </div>
                <div className="flex items-center gap-3">
                  <Phone size={14} className="text-[#82000D] shrink-0" />
                  <a href={`tel:${phone}`} className="text-[13px] text-[#1C1714]/70 hover:text-[#82000D] transition-colors font-light">
                    {phone}
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Mail size={14} className="text-[#82000D] shrink-0" />
                  <a href={`mailto:${email}`} className="text-[13px] text-[#1C1714]/70 hover:text-[#82000D] transition-colors font-light">
                    {email}
                  </a>
                </div>
              </div>
            ...
            <div className="space-y-2">
              <p className="text-[9px] font-bold tracking-[0.4em] uppercase text-[#82000D]/72">Office Hours</p>
              <p className="text-[0.875rem] text-[#1C1714]/72 font-light">Monday – Saturday</p>
              <p className="text-[0.875rem] text-[#1C1714]/72 font-light">8:00 AM – 6:00 PM EAT</p>
            </div>
          </motion.div>
          ...
          <motion.div {...fadeUp(0.16)}>
            <div className="mb-8">
              ...
              <h2 className="text-2xl lg:text-3xl font-serif font-light text-[#1C1714] leading-snug">
                Tell Us About Your{" "}
                <em className="italic text-[#82000D]">Requirements</em>
              </h2>
              <div className="w-8 h-px bg-[#82000D]/40 mt-5" />
            </div>
            ...
            {sent ? (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[#1C1714]/60 font-light leading-relaxed max-w-xs">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-1.5">
                    <label className="text-[9px] font-bold tracking-[0.35em] uppercase text-[#1C1714]/70">Name</label>
                    <input
                      type="text"
                      required
                      value={form.name}
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[9px] font-bold tracking-[0.35em] uppercase text-[#1C1714]/70">Email</label>
                    <input
                      type="email"
                      required
                      value={form.email}
                ...
                {/* Phone */}
                <div className="space-y-1.5">
                  <label className="text-[9px] font-bold tracking-[0.35em] uppercase text-[#1C1714]/70">Phone</label>
                  <input
                    type="tel"
                    value={form.phone}
                ...
                {/* Inquiry type */}
                <div className="space-y-2">
                  <label className="text-[9px] font-bold tracking-[0.35em] uppercase text-[#1C1714]/70">Inquiry Type</label>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          form.inquiryType === type
                            ...
                            : "border-[#82000D]/20 text-[#1C1714]/50 hover:border-[#82000D]/40 hover:text-[#1C1714]/75"
                        )}
                      >
                        {type}
                      </button>
                ...
                {/* Message */}
                <div className="space-y-1.5">
                  <label className="text-[9px] font-bold tracking-[0.35em] uppercase text-[#1C1714]/70">Message</label>
                  <textarea
                    rows={5}
                    value={form.message}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    loading
                      ...
                      : "border-[#82000D]/40 text-[#1C1714]/80 hover:bg-[#82000D] hover:border-[#82000D] hover:text-[#FAF8F4]"
                  )}
                >
